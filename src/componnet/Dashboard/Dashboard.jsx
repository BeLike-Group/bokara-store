    ...
    <div className="flex bg-gray-100">
      ...
      <div className={`fixed top-0 left-0 h-full bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 lg:block lg:w-64`}>
        <div className="flex flex-col h-full p-4 bg-white border-r border-gray-200 dark:bg-gray-800">
          {/* Logo */}
          <a href="#" className="flex items-center justify-center gap-2 py-4 cursor-pointer lg:justify-start">
            <FaCode className="text-3xl text-blue-600" />
            <span className="hidden text-lg font-bold text-gray-800 lg:block dark:text-gray-100">My Store</span>
          </a>
          {/* Menu */}
          <div className="flex flex-col flex-grow">
            <div className="mt-4 space-y-2">
              <div className="px-5">
                <span className="text-xs font-bold text-gray-600 uppercase dark:text-gray-300">Menu</span>
              </div>
              {/* Links */}
              <NavLink to="#" onClick={() => handleMenuClick("dashboard")} className="flex items-center h-12 px-4 font-semibold text-gray-500 transition duration-200 rounded-md hover:text-blue-600 hover:bg-blue-50">
              ...
              <NavLink to="#" onClick={() => handleMenuClick("profile")} className="flex items-center h-12 px-4 font-semibold text-gray-500 transition duration-200 rounded-md hover:text-blue-600 hover:bg-blue-50">
                <RiAdminLine className="text-xl text-gray-600 hover:text-blue-600" />
                <span className="ml-3 text-xl font-bold">Profile</span>
              </NavLink>
              <NavLink to="#" onClick={() => handleMenuClick("customers")} className="flex items-center h-12 px-4 font-semibold text-gray-500 transition duration-200 rounded-md hover:text-blue-600 hover:bg-blue-50">
              <FaPlus className="text-xl text-gray-600 hover:text-blue-600" />
              <span className="ml-3 text-xl font-bold">Create Store</span>
              </NavLink>
              <NavLink to="#" onClick={() => handleMenuClick("chart")} className="flex items-center h-12 px-4 font-semibold text-gray-500 transition duration-200 rounded-md hover:text-blue-600 hover:bg-blue-50">
              ...
              <NavLink to="#" onClick={() => handleMenuClick("orders")} className="flex items-center h-12 px-4 font-semibold text-gray-500 transition duration-200 rounded-md hover:text-blue-600 hover:bg-blue-50">
              ...
              <NavLink to="/" className="flex items-center h-12 px-4 font-semibold text-gray-500 transition duration-200 rounded-md hover:text-blue-600 hover:bg-blue-50">
      ...
      <div className="flex-1 p-4 ml-0 lg:p-8 lg:ml-64">
        <button className="absolute text-black sm:top-0   lg:hidden top-6  left-2 font-bold " onClick={toggleSidebar}>
            ...
            <div className="p-3 mb-4 bg-white shadow-2xl rounded-xl">
              <div className="p-4 bg-gray-200 shadow-2xl rounded-xl">
                <div className="flex flex-col items-center justify-between mb-6 lg:flex-row">
                  ...
                  <button className="px-4 py-2 text-white transition duration-300 bg-blue-600 rounded-lg shadow-md hover:bg-blue-700">Add New Product</button>
                </div>
                {/* Stats Section */}
